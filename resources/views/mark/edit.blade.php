...
@php use App\Enums\ExamType;  @endphp
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <form method="POST" action="{{route('student_marks.update' , ['language' => app()->getLocale() , 'student_mark' => $record->id])}}">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                            <div class="mdc-text-field">
                                ...
                                <select class="mdc-text-field__input form-control " name="exam_type">

                                    @foreach(ExamType::cases() as $type)
                                        <option class="text-center"
                                            @if($type->value === $record->exam_type->value) selected @endif
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                            <div class="mdc-text-field">
                                <input type="number" min="1" max="5" class="mdc-text-field__input"
                                       id="text-field-hero-input" name="exam_number"
                                       value="{{$record->exam_number}}">
                                <div class="mdc-line-ripple"></div>
                                <label for="text-field-hero-input"
                ...
                <div class="form-group row justify-content-center mb-3">
                    <div class="col-md-6">
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                            <div class="mdc-text-field">
                                <input type="number" min="1" max="100" class="mdc-text-field__input"
                                       step="0.01"    id="text-field-hero-input" name="student_mark"
                                       value="{{$record->student_mark}}">
                                <div class="mdc-line-ripple"></div>
                                <label for="text-field-hero-input"
                                       class="mdc-floating-label">{{__('Student Mark')}}</label>
                            </div>
                        </div>
                    </div>
                    <div class="text-danger text-center">
                        @error('student_mark')  {{$message}}   @enderror
                    </div>
                </div>
