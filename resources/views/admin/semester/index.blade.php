...
@section('content')
    ...
    <div class="container mt-0">
        ...
        <h2 class="text-center">{{ __('Semesters') }} </h2>
            ...
            <a href="{{ route('semesters.create' , app()->getLocale()) }}"
                        ...
                        @foreach ($records as $record)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form
                                            action="{{ route('semesters.destroy', ['language' => app()->getLocale(), 'semester' => $record->id]) }}"
                                            method="post">

                                            <input type="hidden" name="id" value="{{ $record->id }}">
                                        <a href="{{ route('semesters.edit', ['language' => app()->getLocale(), 'semester' => $record->id]) }}"
